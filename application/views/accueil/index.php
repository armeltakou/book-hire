...
<div class="home_search" style="margin-bottom: 5%;">
    <div class="container">
        <div class="row">
            <div class="col">
                    ...
                    <div class="home_search_content">
                        <form action="#" class="search_form d-flex flex-row align-items-start justfy-content-start">
                            <div class="search_form_content d-flex flex-row align-items-start justfy-content-start flex-wrap">
                                ...
                                <div>
                                    <input type="text" class="search_form_select" required placeholder="Entrer le lieu">
                                </div>
                                <div>
                                    <input type="date" class="search_form_select" required data-validation-required-message="Entrer la date de début">
                                </div>
                                <div>
                                    <input type="time" class="search_form_select" required data-validation-required-message="Entrer une heure">
                                </div>
                                <div>
                                    <input type="date" class="search_form_select" required data-validation-required-message="Entrer une date de fin">
                                </div>
                            </div>
